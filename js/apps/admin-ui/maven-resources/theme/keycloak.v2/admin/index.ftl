...
<html lang="en">
  <head>
    ...
    <meta name="description" content="${properties.description!'The Beep Pakistan Administration Console is a web-based interface for managing.'}">
    <title>${properties.title!'Beep Pakistan Administration Console'}</title>
    <style>
      body {
        margin: 0;
      }

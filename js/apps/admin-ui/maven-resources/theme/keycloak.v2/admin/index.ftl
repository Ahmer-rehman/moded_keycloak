...
<html lang="en">
  <head>
    ...
    <meta name="description" content="${properties.description!'The beep Auth Administration Console is a web-based interface for managing Keycloak.'}">
    <title>${properties.title!'Beep Auth Administration Console'}</title>
    <style>
      body {
        margin: 0;
      }
